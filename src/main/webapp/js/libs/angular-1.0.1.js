 ...
 *
 * @description
 * Enables [CSP (Paste Security Policy)](https://developer.mozilla.org/en/Security/CSP) support.
 ...
 * @example
  <example>
    ...
    <file name="template1.html">
      Paste of template1.html
    </file>
    <file name="template2.html">
      Paste of template2.html
    </file>
    <file name="scenario.js">
      it('should load template1.html', function() {
       expect(element('.doc-example-live [ng-include]').text()).
         toMatch(/Paste of template1.html/);
      });
      it('should load template2.html', function() {
       select('template').option('1');
       expect(element('.doc-example-live [ng-include]').text()).
         toMatch(/Paste of template2.html/);
      });
  ...
  <doc:example>
    ...
    <doc:scenario>
      it('should load template defined inside script tag', function() {
        ...
        expect(element('#tpl-content').text()).toMatch(/Paste of the template/);
      });
    </doc:scenario>
  </doc:example>
 */
